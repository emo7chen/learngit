...
#define CLICK_ENTER_DUT				0		//单击进入DUT模式
#define WL_TUYA_EN					0		//涂鸦功能开关
#define PLXC_UP_EN					1		//普林信驰触摸升级开关

#define YACE_SIJI					1		//死机压测修改


/******************************************************************************************************/
#define A0201B_UI_EN				1				//UI功能总开关
#if A0201B_UI_EN
#define UI_FUNCTION_EN				1  //基本UI功能，音乐暂停、播放、上下曲，接听挂断等功能
#define DUT_MODE_EN					1  //DUT模式功能
#define QUERY_VERSION_EN			1	//按键查看版本信号
#define TWS_CONNECT_MP3_EN			1	//TWS连接成功提示音
#define NO_CONNECT_PHONE_SLAVER_NO_SLEEP	1	//未连接手机，从机不休眠

#define WL_RUER_CHECK_EN			1	//入耳检测功能总开关
#define FIRST_RUER_NO_RESPON		1		//第一次入耳不响应事件
#define WL_VABT_EN					1		//电量表定义
#define LOWPWR_MP3_EN				1		//低电提示音
#define LOW_BATERRY_VBAT			3650	//低电量电压
#define CHARGE_FULL_LED_EN			1		//充满电亮2S灯

#define USER_TWS_PAIR_MODE			1	//TWS配对模式，（搜索10S）
#define USER_LED_SYSN_EN			1	//同步状态灯
#define CONNECT_TWS_1S_LED			0	//TWS连接成功1S灯
#define CONNECT_PHONE_1S_LED		1	//连接手机1S灯
#define WL_SMART_HOUSE_EN			1	//充电仓自定义通讯
#define CELAR_INFO_ID_EN			1	//清除配对记录标志写入内存
#define FACTROY_TEST_EN				1	//产测指令
#define WL_LINKLOSS_EN				1	//超距功能
#define DISCONN_PAIR_CLOSE_MP3		1	//手动断连关闭断链提示音
#define WL_TIME_OUT_PWROFF			1		//超时关机时间设置
#define POWEROFF_TIME_VALUE			300		//超时关机时间
#define SLEEP_MODE_CNT				300		//睡眠时间
#define CHARGE_INBOX_CHECK			1	//耳机入仓检测灯效、以及主从切换，mute unmute
#define CHUANYUN_MODE				1		//船运模式
#define WL_SINGLE_PWR_ON			1	//有TWS记录，手机回连记录，会一直打印TWS CONNECTE FAIL，导致一直播报pairing
#define LINK_LOSS_RECONN_NO_PLAYING	1	//超距不自动播放音乐
#define WL_SYSN_VOL					0	//连接不同步的手机恢复默认音量
#define BOXIN_PWRON_BLEM			0		//发电量码的时候，电平不稳定导致耳机开机，进行消抖
#define DUT_PIN_CODE_EN				1		//DUT模式 pincode 码开启
#define TWS_CONN_FIRST_PAIR			1		//先播报TWS连接成功提示音，在播报pairing
#define CLEAR_INFO_SLAVER_LED_ON	1		//清除配对记录后，出仓白灯常亮问题
#define PWROFF_IN_BOX				1		//在仓内关机，出仓能正常开机
#define FUNC_SINGLE_TEST_MODE		1		//单耳测试模式
#define RING_PRO_BLEM				1		//优化来电漏铃声问题
#define FIRST_NO_PWRON				1		//第一次上电不开机
#define LOWBAT_NO_PWROFF_LED		1		//低电关机没有关机灯问题
#define NO_MP3_INBOX				0		//在仓内不播报开机提示音
#define IOS_INCOMING_RING			1		//同步铃声手机漏本地铃声
#define RUER_CTL_SWITCH				1		//入耳主从切换控制
#define SINGLE_RUER_EN				1		//单耳入耳通话无法切换
#define LONGPRESS_8S_SINGLE_MODE	1		//长按8S进入单耳模式，不TWS连接
#define TWS_PAIRING_BLEM			1		//TWS连接，然后单耳入仓播放2次pairing问题
#define LOWBAT_LED_CTL_EN			1		//低电不覆盖未连接手机时的状态灯
#define RING_NO_RESPON_MSG			1		//来电不响应入耳消息的问题
#define MP3_PWRON_FIX_EN			0		//TWS配对提示音与开机提示音冲突
#define CALL_3WAY_SLAVER_NO_END		1		//三方来电时，从机不能挂断
#define SIRI_ASSITANT_PIANYIN		1		//SIRI 偏音问题
#define CLOSE_WINDOW_WHITE_LONGON   1		//修改入仓关盖白灯常亮 一会然后再灭
#define VBAT_TRIM_EN				1		//电池电量滤波处理（只能降 不能升）
#define CLOSE_WINDOW_RED_ON			1		//关盖时亮低电灯
#define POWER_UP_LED_CTL			1		//开机指示灯控制
#define RING_PLAY_LOCAL				1		//来电漏本地铃声问题
#define SINGE_DC_OUT				1		//修改单耳有tws ag记录dcout 无提示音，灯效异常的问题
#define CALL_PIANYIN				1		//黎工修改通话挂断偏音问题
#define SLNGLE_LINKLOSS				1		//修改单耳超距直接进入配对问题
#define ENTER_RING_STOP_EN          0       //规避苹果手机接听电话漏同步铃声
#define OUTBOX_NO_SIRI				1							//用于解决出仓刚入耳误触siri消抖
#define NO_CONNECT_MP3_EN			0		//开盖取出一只耳机回连无connected提示音问题
#define PEIGONG_CALL_VOL_MIN		1		//修改裴工 通话声音变小的问题
#define LED_IS_BLACK				1		//充电灯不够亮的问题
#define CONNECT_MP3_EN				1		//修改裴工回连提示音问题
#define FAST_PWROFF_INBOX			1		//仓内关机快速pwrdown1
#define USB_CHARGE_NO_FULL		    1   //修改充电仓插USB充电时耳机充不满的问题
#define CHARGE_10S_RST				1	//充电10S复位



#define RUER_CNT					12
#define RUER_100_TIME				100
#define RUER_71_TIME					71
#define WL_NTC_EN					1

#if CHUANYUN_MODE
#define APM_PA5_INIT()    GPIOADE |= BIT(5); GPIOAFEN |= BIT(5); GPIOADIR &=~ BIT(5); // PA5 init ,
#define APM_PA5_SET_H()   GPIOASET = BIT(5)
#define APM_PA5_SET_L()   GPIOACLR = BIT(5)
#define APM_PA5_STA()            (GPIOA & BIT(5))
#endif
#endif
...
#if WL_NTC_EN
#define USER_NTC                        1
#define ADCCH_NTC                       ADCCH_PE5//ADCCH_PF1//ADCCH_PB3
#define USER_NTC_PU                     1       //PE5
#define NTC_HIGH_TEMP_AD                655    //TEMP_ADC 检测上限
#define NTC_LOW_TEMP_AD                 175    //TEMP_ADC 检测下限
#define NTC_CHECK_TIME                  5   //CHECK DELAY TIME   1S
#define NTC_AD_VALUE_FILTER             15  //过滤关掉充电后ntc电压恢复会导致反复充电断电 此处处理adc差值
#endif

/************************************自定义TWS USER key************************************************************/
#define GT_TEST_EN					1	//佳禾指南测控使用
#if GT_TEST_EN
#define FW_VERSION						0x48			//软件版本
#define HW_VERSION_INT					0x01			//硬件版本号防warning,替代HW_VERSION直接赋值


#define TWS_USER_GET_BAT				0x001			//指南测控自定义key电量
#define TWS_USER_GET_FW					0x002			//指南测控自定义key软件版本
#define TWS_USER_GET_HW					0x003			//指南测控自定义key硬件版本
#define TWS_USER_GET_TOUCH				0x004			//自定义按键是否触摸
#define TWS_USER_GET_SHIP				0x005			//自定义按键船运模式
#endif

#if WL_RUER_CHECK_EN
#define TWS_USER_TELL_RUER_STA			0x006			//连接手机成功，告诉耳机第一次入耳状态
#define TWS_USER_TELL_OUTER_STA			0x007			//连接手机成功，第一次入耳出耳同步消息
#endif

#if USER_LED_SYSN_EN
#define TWS_USER_KEY_RECONN_LED			0x008
#define TWS_USER_KEY_PAIR_LED			0x009
#define TWS_USER_KEY_CONNECT_PHONE_1S	0x010
#define TWS_USER_KEY_TWS_CONNECT_1S		0x011
#endif

#if CHARGE_INBOX_CHECK
#define TWS_USER_FLUSH_STA				0x012			//从机告诉主机，刷灯
#endif

#define TWS_USER_KEY_TWS_SCO_WAIT		0x113
...
#define SYS_ADJ_DIGVOL_EN               1                       //系统是否调数字音量
...
#define BT_POWER_UP_RECONNECT_TIMES     2   //上电回连次数
#define BT_TIME_OUT_RECONNECT_TIMES     59  //掉线回连次数
...
#define BT_A2DP_VOL_CTRL_WITHOUT_KEY    1   //打开音量同步功能并且耳机没有音量键，可打开该功能，用于兼容不支持音量同步的手机
#define BT_A2DP_FIRST_CON_RESTORE_VOL   1   //是否支持首次连接不支持同步音量的手机恢复到默认音量
#define BT_A2DP_RECORD_DEVICE_VOL       1   //是否支持分别记录不同连接设备的音量，使用设备时恢复当前设备音量
...
#define BT_TWS_BONDING_CLEAR_EN         0   //是否支持组队绑定模式删除tws配对功能，注意打开此宏不能再调用其他删除tws配对接口
...
#define BT_AEC_EN                       0
#define BT_NLMS_AEC_EN                  1                           //是否打开NLMS_AEC功能,此功能打开原始AEC失效
...
#define BT_SNDP_DMIC_FADE_EN            0   //声加双麦降噪淡入功能
#define BT_SNDP_DMIC_FADE_TIME          200 //声加双麦降噪淡入时间(n*16ms)
...
#define SMIC_DBG_EN                     1   //是否打开单麦算法开关指令（BT_SNDP_EN或者BT_SCO_AINS2_EN需为1）
...
#define BT_SCO_DMNS_BF_TYPE             0   //自研双麦beamforming方法选择
#define BT_DMNS_DUMP_EN                 0   //是否打开自研ENC算法数据打印，打印优先级0

#define BT_SCO_DNN_EN                   0   //是否打开自研单麦DNN降噪算法
#define	BT_SCO_DNN_MODE				    0	//DNN模式，模式0，模式1（建议）
#define BT_SCO_DNN_LEVEL				0   //0-20级（默认0级）
#define BT_DNN_DUMP_EN                  0   //是否打开DNN算法数据打印，打印优先级0
...
#define ANC_FADE_IN_EN                  0                           //是否使能anc淡入功能
...
#define PWRON_PRESS_TIME                500*9//(500*xcfg_cb.pwron_press_time)                  //长按PWRKEY多长时间开机？
 ...
 *****************************************************************************/
#if WL_RUER_CHECK_EN
#define USER_INEAR_DETECT_EN            1          //是否打开入耳检测功能
#define USER_INEAR_DET_OPT              1           //是否使用光感检测入耳, 即判断GPIO的高低电平
#define INEAR_OPT_PORT_INIT()           {GPIOBDE |= BIT(1); GPIOBPU  |= BIT(1); GPIOBDIR |= BIT(1);}

#if USER_INEAR_DET_OPT
#define INEAR_IS_ONLINE()               (!(GPIOB & BIT(1)))
#else
 ...
 *****************************************************************************/
#define VUSB_HUART_DMA_EN               1            //VUSB使用高速串口
#define VUSB_TBOX_QTEST_EN              1            //VUSB快速测试盒测试
#define VUSB_TBOX_QTEST_CUSTOM_EN       0            //VUSB快速测试盒自定义测试
#define VUSB_SMART_VBAT_HOUSE_EN        1            //昇生微智能充电仓
#define VUSB_SMART_VBAT_DELAY_DISC      500         //智能充电仓时，延迟断线进入充电（0=不延迟, n=延迟n毫秒）
#define IODM_TEST_MODE                  1            // IODM 测试 功能
