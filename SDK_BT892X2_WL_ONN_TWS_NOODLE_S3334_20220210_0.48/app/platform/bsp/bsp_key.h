...
#if UI_FUNCTION_EN				//修改长按事件时间
#define KEY_LONG_TIMES          80         //长按键的次数
#else
#define KEY_LONG_TIMES          150         //长按键的次数
#endif
#define KEY_HOLD_TIMES          40          //连按的频率次数
...
#define EVT_AUTO_PWFOFF_EN      0x7cb
#define EVT_AUTO_PWFOFF_DIS     0x7ca

#define EVT_SYNC_SCO_WAIT        0x7c9
#define EVT_SYNC_SCO_ON          0x7c8


#if QUERY_VERSION_EN
#define EVT_LONGPRESS_3S		0x8df			//长按3S事件
#endif
#if USER_INEAR_DETECT_EN ||CHARGE_INBOX_CHECK
#define EVT_INEAR				0x8de
#define EVT_OUTEAR				0x8dd
#define EVT_TWS_SWITCH			0x8dc	//主从切换
#define EVT_CALL_PRIVATE_SWITCH	0x8db	//通话切换
#define EVT_PRIVATE_CALL		0x9df	//隐私通话切换

#endif

#if USER_TWS_PAIR_MODE
#define EVT_TWS_PAIR			0x8da	//TWS配对
#endif

#if WL_SMART_HOUSE_EN
#define EVT_CLEAR_INFO			0x8d9	//通讯----清除配对记录
#define EVT_ENTER_PAIR_MODE		0x8d8	//通讯---- 进入配对状态
#define EVT_PWR_OFF				0x8d7	//通讯---关机码
#endif

#if CHARGE_INBOX_CHECK		
#define EVT_FADE_IN				0x8d6	//入仓静音
#define EVT_FADE_OUT			0x8d5	//出仓解mute，恢复声音
#define EVT_ENTER_SLEEP_MODE	0x8d4	//入仓进入睡眠模式
#define EVT_OUTER_SLEEP_MODE	0x8d3	//出仓退出睡眠模式
#define EVT_TIMEOUT_PWR_OFF		0x8d2	//超时关机消息
#endif
#if TWS_CONN_FIRST_PAIR
#define PAIRIG_MP3				0x8d1
#endif
#define EVT_SHIPMODE			0x8d0
#define EVT_SPT51               0x9dc
#define EVT_SPT51_11_GUDING		0x9db
#define EVT_SPT51_12_GUDING		0x9da
#define EVT_SPT51_800_GUDING	0x9d9
#define EVT_SPT51_816_GUDING	0x9d8
#define EVT_LONGPRESS_1_5S		0x9d7
#define EVT_LONGPRESS_5S		0x9d6
#define EVT_SPT51_V15_GUDING	0x9d5
#define EVT_300_PWR_OFF			0x9d4
...
void key_init(void);
void bsp_adc_recover_start(void);
