...
#define PARAM_CLEAR_INFO_FLAG		0xec			//清除配对记录标志1byte

#if GT_TEST_EN						// 指南测控
#define PARAM_GT_ID                 0xed         //ID的存储空间4bytes
//#define PARAM_GT_SN_LEN             0xf0         //SN的长度
//#define PARAM_GT_SN                 0xf1         //SN的存储空间16bytes
#endif
#if CHARGE_INBOX_CHECK
#define PARMAM_PWR_FLAG				0xd3		//区分关机方式
#endif
