...
#if LINK_LOSS_RECONN_NO_PLAYING
#define A2DP_FEATURE        (A2DP_AVRCP_VOL_CTRL*BT_A2DP_VOL_CTRL_EN) | (A2DP_AVDTP_DELAY_REPORT*BT_AVDTP_DELAY_REPORT_EN)
#else
...
#endif
#define A2DP_FEATURE1       (BT_A2DP_VOL_CTRL_WITHOUT_KEY*A2DP_AVRCP_RESET_VOL_CTRL)
...
uint8_t cfg_bt_hci_disc_only_spp = 1;
